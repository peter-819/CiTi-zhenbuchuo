  ...
  export default {
    ...
    data() {
      return {
        ...
        registerInfo : this.$route.query.registerInfo,
        legalPeople : this.$route.query.legalPeople,
        capital: this.$route.query.capital,
        kind: this.$route.query.kind,
        conAddress: this.$route.query.conAddress,
        comTel: this.$route.query.comtel,
      }
    },
    methods: {
      backTo2: function() {
